...
export default class MyOrder extends Component {
  state = {
    status: true,
    token:
      'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZF91c2VyIjo2LCJlbWFpbCI6ImJ1eWVyMUBnbWFpbC5jb20iLCJpYXQiOjE1NzkzNDg5OTB9.Z4H2ickGQqk-pEQHNy2OJpWr62C2rgCTXEzcvqb-8o4',
                      ...
                      <View style={styles.child2}>
                        ...
                        <View style={styles.child22}>
                          <Button
                            ...
                            <Text style={styles.textChild22}>Chat Seller</Text>
                          </Button>
                        </View>
                      </View>
                    </View>
              ...
              {this.state.completedOrder.length > 0 ? (
                ...
                <View style={styles.cardParent}>
                  <View
                    ...
                    />
                    <Text>oopps seems like you dont have any completed order yet</Text>
                  </View>
                </View>
              )}
            </ScrollView>
