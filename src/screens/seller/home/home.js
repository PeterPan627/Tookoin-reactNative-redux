                ...
                <ScrollView>
                    ...
                    <View style={styles.body3}>
                        <TouchableOpacity style={styles.body3Content}>
                            <IconMI style={styles.body3Icon} color="#f67533" name="local-atm" />
                        ...
                        <View style={styles.hr2} />
                        <TouchableOpacity style={styles.body3Content}>
                            <IconMI style={styles.body3Icon} color="#314fe8" name="local-shipping" />
                        ...
                        <View style={styles.hr2} />
                        <TouchableOpacity style={styles.body3Content}>
                            <IconMI style={styles.body3Icon} color="#314fe8" name="supervisor-account" />
                            <Text style={styles.addText}>Asisten Penjual</Text>
                            <IconMI style={styles.detailAdd} name="navigate-next" />
                        </TouchableOpacity>
                        <View style={styles.hr2} />
                        <TouchableOpacity style={styles.body3Content}>
                            <IconMI style={styles.body3Icon} color="#31e865" name="help-outline" />
